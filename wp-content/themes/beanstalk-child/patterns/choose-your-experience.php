 ...
 * Slug: beanstalk-child/choose-your-experience
 * Categories: featured
 * Keywords: clinic, location, experience
 * Description: Editable two-clinic comparison for White Oaks Mall Dental and Oaks Dental Wellness.
 */
?>
<!-- wp:group {"align":"full","className":"experience-section","layout":{"type":"default"}} -->
<div class="wp-block-group alignfull experience-section"><!-- wp:group {"align":"wide","className":"experience-section__inner","layout":{"type":"default"}} -->
...
<p class="experience-section__eyebrow">Choose your experience</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"className":"experience-section__title","fontSize":"experience-heading","fontFamily":"heading"} -->
<h2 class="wp-block-heading experience-section__title has-heading-font-family has-experience-heading-font-size">Find the clinic that's <em>right for you.</em></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph {"className":"experience-section__intro","fontSize":"b-3","fontFamily":"body"} -->
<p class="experience-section__intro has-body-font-family has-b-3-font-size">With two London clinics, you can choose the care and the setting that fit your needs.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="experience-card__status">Accepting new patients</p>
...
<p class="experience-card__eyebrow">Your neighbourhood clinic</p>
<!-- /wp:paragraph -->
...
<h3 class="wp-block-heading experience-card__title has-heading-font-family has-experience-card-heading-font-size">White Oaks Mall</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"experience-card__copy","fontSize":"experience-card-copy","fontFamily":"body"} -->
<p class="experience-card__copy has-body-font-family has-experience-card-copy-font-size">Complete family dental care in a warm, welcoming space, with convenient evening and Saturday appointments.</p>
<!-- /wp:paragraph -->
...
<p class="has-body-font-family has-b-6-font-size">1105 Wellington Rd<br>London, ON N6E 1V4</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"experience-card__meta-secondary","fontSize":"b-6","fontFamily":"body"} -->
<p class="experience-card__meta-secondary has-body-font-family has-b-6-font-size">Mon–Thu · 9–8<br>Fri 8–3 · Sat 9–2</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-text"><a class="wp-block-button__link wp-element-button" href="#"><span>Book at this clinic</span><span aria-hidden="true">↗</span></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<p class="experience-card__status">Opening 2026</p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:cover -->
...
<div class="wp-block-group experience-card__content"><!-- wp:group {"className":"experience-card__topline","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group experience-card__topline"><!-- wp:paragraph {"className":"experience-card__eyebrow"} -->
<p class="experience-card__eyebrow">A new standard of dental wellness</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3,"className":"experience-card__title","fontSize":"experience-card-heading","fontFamily":"heading"} -->
<h3 class="wp-block-heading experience-card__title has-heading-font-family has-experience-card-heading-font-size">Oaks Dental Wellness</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"experience-card__copy","fontSize":"experience-card-copy","fontFamily":"body"} -->
<p class="experience-card__copy has-body-font-family has-experience-card-copy-font-size">A refined clinic created around privacy, unhurried appointments, and a deeply personal approach to lifelong oral health.</p>
<!-- /wp:paragraph -->

<!-- wp:group {"className":"experience-card__meta","layout":{"type":"default"}} -->
<div class="wp-block-group experience-card__meta"><!-- wp:paragraph {"fontSize":"b-6","fontFamily":"body"} -->
<p class="has-body-font-family has-b-6-font-size">London, Ontario<br>Location to be announced</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"experience-card__meta-secondary","fontSize":"b-6","fontFamily":"body"} -->
<p class="experience-card__meta-secondary has-body-font-family has-b-6-font-size">Founding patient<br>updates coming soon</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
